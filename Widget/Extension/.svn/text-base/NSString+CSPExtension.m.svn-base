...
#import "NSData+CSPExtension.h"
#import <CommonCrypto/CommonDigest.h>
#import "NSObject+CSPTypeConversion.h"

TT_FIX_CATEGORY_BUG(NSString_CSPExtension)
...
@implementation NSString(CSPExtension)
...
- (BOOL)isEmail2 {
    NSString * MOBILE = @"^([a-zA-Z0-9_\\-\\.]+)@(([a-zA-Z0-9_\\-]+\\.)+)([a-zA-Z]{2,4})(\\]?)$";
...
//    NSString *		regex = @"http(s)?:\\/\\/([\\w-]+\\.)+[\\w-]+(\\/[\\w- .\\/?%&=]*)?";
    NSString *		regex = @"((http[s]{0,1}|ftp)://[a-zA-Z0-9\\.\\-]+\\.([a-zA-Z0-9]{2,4})(:\\d+)?(/?[a-zA-Z0-9\\.\\-~!@#$%^&*+?:_/=<>]*)?)|([a-zA-Z0-9\\.\\-]+\\.[a-zA-Z0-9\\.\\-]+\\.([a-zA-Z]{2,4})(:\\d+)?(/?[a-zA-Z0-9\\.\\-~!@#$%^&*+?:_/=<>]*)?)";
    NSPredicate *	pred = [NSPredicate predicateWithFormat:@"SELF MATCHES %@", regex];
...
//    NSString * PHS = @"/^((0\\d{2,3})-)(\\d{7,8})(-(\\d{3,}))?$/";
    NSString * PHS = @"((\\d{11})|^((\\d{7,8})|(\\d{4}|\\d{3})-(\\d{7,8})|(\\d{4}|\\d{3})-(\\d{7,8})-(\\d{4}|\\d{3}|\\d{2}|\\d{1})|(\\d{7,8})-(\\d{4}|\\d{3}|\\d{2}|\\d{1}))$)";
    NSPredicate *regextestmobile = [NSPredicate predicateWithFormat:@"SELF MATCHES %@", MOBILE];
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    return [self sizeWithFont:font constrainedToSize:CGSizeMake(width, 999999.0f) lineBreakMode:NSLineBreakByWordWrapping];
...
#pragma clang diagnostic push
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    return [self sizeWithFont:font constrainedToSize:CGSizeMake(999999.0f, height) lineBreakMode:NSLineBreakByWordWrapping];
    #pragma clang diagnostic pop
}
...
@implementation NSMutableString(CSPExtension)
