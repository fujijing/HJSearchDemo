...
- (void)commonInit {
    ...
    self.blackOverlayInset = UIEdgeInsetsZero;
}
...
- (void)showAtPoint:(CGPoint)point
    ...
    self.blackOverlay.frame = CGRectMake(self.blackOverlayInset.left,
            self.blackOverlayInset.top,
            containerView.bounds.size.width - self.blackOverlayInset.left - self.blackOverlayInset.right,
            containerView.bounds.size.height - self.blackOverlayInset.top - self.blackOverlayInset.bottom);
